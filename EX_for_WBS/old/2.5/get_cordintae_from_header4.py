...
header3_binari_dir = "header3_binari"
header4_binari_dir = "header4_binari"
data_dir = "data"
# 出力ディレクトリ
...
for input_file_name in header4_path:
    ...
    # 処理終了
    output_file_name1 = header4_trimmed_dir+'/'+str(count1) + ".png"
...
for input_file_name in header4_trimmed_path:
    ...
    cv2.imwrite(header4_binari_dir+"/binari" + str(count)+".png",Img_binari_line)
    count2 += 1
...
np.savetxt("coordinate_by_header4.csv", coordinate_array, fmt="%d", delimiter=",")
